...
namespace StartUpApi.Migrations
{
    ...
    [Migration("20180728232507_addedUserSession")]
    partial class addedUserSession
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("StartUpApi.Models.AuditTrail", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("StartUpApi.Models.OrganizationUnit", b =>
                {
            ...
            modelBuilder.Entity("StartUpApi.Models.UserOrganization", b =>
                {
                    b.Property<int>("OrganizationId");
            ...
            modelBuilder.Entity("StartUpApi.Models.UserSession", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("StartUpApi.Models.OrganizationUnit", b =>
                {
                    b.HasOne("StartUpApi.Models.OrganizationUnit", "PARENT")
                        .WithMany()
            ...
            modelBuilder.Entity("StartUpApi.Models.UserOrganization", b =>
                {
                    b.HasOne("StartUpApi.Models.OrganizationUnit", "ORGANIZATIONUNIT")
